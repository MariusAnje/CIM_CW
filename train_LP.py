...
def LTrain(epochs, header, lmd, beta, dev_var=0.0, write_var=0.0, verbose=False):
    best_acc = 0.0
    for i in range(epochs):
        model.train()
        running_loss = 0.
...
if __name__ == "__main__":
    ...
    parser.add_argument('--lmd', action='store',type=float, default=1,
            help='lambda number')
    ...
    LTrain(args.train_epoch, header, lmd=args.lmd, beta=args.beta, dev_var=args.train_var, write_var=0.0, verbose=args.verbose)
